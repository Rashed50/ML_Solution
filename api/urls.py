...
from .views import GenerateCard, SaveCard, TestEndpoint,imageProcessing,imageToCSV,hello_api,image_edge_detection
...
urlpatterns = [
  ...
  #  path('save-card/', SaveCard.as_view(), name='save_card'),
    ...
    path('image-to-csv/',  imageToCSV, name='image-to-csv'),  # Example test endpoint
